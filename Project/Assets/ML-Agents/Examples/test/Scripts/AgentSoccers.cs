...
public class AgentSoccers : Agent
{
    ...
    SoccersSettings m_SoccerSettings;
    ...
    void OnCollisionEnter(Collision c)
    {
        ...
        if (c.gameObject.CompareTag("ball"))
        {
            ...
            dir = dir.normalized;
            c.gameObject.GetComponent<Rigidbody>().AddForce(dir * force * m_ForwardSpeed);
        }
    }
